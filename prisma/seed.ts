...
async function main() {
  ...
  const areas = await Promise.all([
    prisma.area.upsert({ where: { slug: 'shoreditch' }, update: {}, create: { name: 'Shoreditch', slug: 'shoreditch', description: 'East London\'s creative heartland. Street art, independent boutiques, rooftop bars, and some of the city\'s most interesting restaurants.', heroImage: 'https://images.unsplash.com/photo-1517502884422-e8e5f25a7bff?w=1200&h=600&fit=crop', latitude: 51.5246, longitude: -0.0794 } }),
    prisma.area.upsert({ where: { slug: 'soho' }, update: {}, create: { name: 'Soho', slug: 'soho', description: 'The beating heart of London\'s West End. Restaurants, theatres, bars, and an energy that never really stops.', heroImage: 'https://images.unsplash.com/photo-1533929736562-87b04b5ba4ea?w=1200&h=600&fit=crop', latitude: 51.5137, longitude: -0.1337 } }),
    prisma.area.upsert({ where: { slug: 'camden' }, update: {}, create: { name: 'Camden', slug: 'camden', description: 'Music venues, eclectic markets, canal-side pubs, and a spirit of independence that defines North London.', heroImage: 'https://images.unsplash.com/photo-1528809217021-151305b04551?w=1200&h=600&fit=crop', latitude: 51.5392, longitude: -0.1426 } }),
    ...
    prisma.area.upsert({ where: { slug: 'greenwich' }, update: {}, create: { name: 'Greenwich', slug: 'greenwich', description: 'Maritime history, the Meridian Line, a beautiful park, and a thriving market. One of London\'s most rewarding day trips.', heroImage: 'https://images.unsplash.com/photo-1582719471384-894fbb16564e?w=1200&h=600&fit=crop', latitude: 51.4769, longitude: -0.0005 } }),
    prisma.area.upsert({ where: { slug: 'notting-hill' }, update: {}, create: { name: 'Notting Hill', slug: 'notting-hill', description: 'Pastel houses, Portobello Road Market, independent cinemas, and a village feel in the middle of West London.', heroImage: 'https://images.unsplash.com/photo-1516637090014-cb1ab78511f5?w=1200&h=600&fit=crop', latitude: 51.5093, longitude: -0.1963 } }),
...
<p>If you want theatre that's more interesting than the average West End show, the Young Vic in Waterloo consistently programmes bold, surprising work. They keep ticket prices accessible too, with some at £10.</p>`,
    ...
    prisma.article.upsert({
      ...
      create: {
        ...
        featureImage: 'https://images.unsplash.com/photo-1517502884422-e8e5f25a7bff?w=1200&h=700&fit=crop',
    ...
    prisma.article.upsert({
      ...
      create: {
        ...
        featureImage: 'https://images.unsplash.com/photo-1582719471384-894fbb16564e?w=1200&h=700&fit=crop',
    ...
    prisma.article.upsert({
      ...
      create: {
        ...
        featureImage: 'https://images.unsplash.com/photo-1533929736562-87b04b5ba4ea?w=800&h=500&fit=crop',
    ...
    prisma.article.upsert({
      ...
      create: {
        ...
        featureImage: 'https://images.unsplash.com/photo-1545042746-ec9e50e7db86?w=800&h=500&fit=crop',
  ...
  const events = await Promise.all([
    ...
    prisma.event.upsert({
      ...
      create: {
        ...
        featureImage: 'https://images.unsplash.com/photo-1528809217021-151305b04551?w=1200&h=700&fit=crop',
        categoryId: foodDrink.id,
        areaId: camden.id,
