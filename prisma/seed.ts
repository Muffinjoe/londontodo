...
async function main() {
  ...
  const areas = await Promise.all([
    prisma.area.upsert({ where: { slug: 'shoreditch' }, update: {}, create: { name: 'Shoreditch', slug: 'shoreditch', description: 'East London\'s creative heartland. Street art, independent boutiques, rooftop bars, and some of the city\'s most interesting restaurants.', heroImage: 'https://images.unsplash.com/photo-1534430480872-3498386e7856?w=1200&h=600&fit=crop', latitude: 51.5246, longitude: -0.0794 } }),
    prisma.area.upsert({ where: { slug: 'soho' }, update: {}, create: { name: 'Soho', slug: 'soho', description: 'The beating heart of London\'s West End. Restaurants, theatres, bars, and an energy that never really stops.', heroImage: 'https://images.unsplash.com/photo-1542435503-956c469947f6?w=1200&h=600&fit=crop', latitude: 51.5137, longitude: -0.1337 } }),
    prisma.area.upsert({ where: { slug: 'camden' }, update: {}, create: { name: 'Camden', slug: 'camden', description: 'Music venues, eclectic markets, canal-side pubs, and a spirit of independence that defines North London.', heroImage: 'https://images.unsplash.com/photo-1569587112025-0d460e81a126?w=1200&h=600&fit=crop', latitude: 51.5392, longitude: -0.1426 } }),
    ...
    prisma.area.upsert({ where: { slug: 'greenwich' }, update: {}, create: { name: 'Greenwich', slug: 'greenwich', description: 'Maritime history, the Meridian Line, a beautiful park, and a thriving market. One of London\'s most rewarding day trips.', heroImage: 'https://images.unsplash.com/photo-1501594907352-04cda38ebc29?w=1200&h=600&fit=crop', latitude: 51.4769, longitude: -0.0005 } }),
...
<p>If you want theatre that's more interesting than the average West End show, the Young Vic in Waterloo consistently programmes bold, surprising work. They keep ticket prices accessible too, with some at £10.</p>`,
    ...
    prisma.article.upsert({
      ...
      create: {
        ...
        featureImage: 'https://images.unsplash.com/photo-1534430480872-3498386e7856?w=1200&h=700&fit=crop',
    ...
    prisma.article.upsert({
      ...
      create: {
        ...
        featureImage: 'https://images.unsplash.com/photo-1542435503-956c469947f6?w=1200&h=700&fit=crop',
    ...
    prisma.article.upsert({
      ...
      create: {
        ...
        featureImage: 'https://images.unsplash.com/photo-1501594907352-04cda38ebc29?w=1200&h=700&fit=crop',
    ...
    prisma.article.upsert({
      ...
      create: {
        ...
        featureImage: 'https://images.unsplash.com/photo-1542435503-956c469947f6?w=800&h=500&fit=crop',
  ...
  const events = await Promise.all([
    ...
    prisma.event.upsert({
      ...
      create: {
        ...
        featureImage: 'https://images.unsplash.com/photo-1569587112025-0d460e81a126?w=1200&h=700&fit=crop',
        categoryId: foodDrink.id,
        areaId: camden.id,
