    ...
    <>
      <article>
        <header className="relative overflow-hidden bg-ink-900">
          <Image src="/images/cs-diverse-9.webp" alt="City Splash Festival carnival dancers" fill priority className="object-cover" sizes="100vw" />
                    ...
                    <div key={i}>
                        ...
                        <>
                          <div className="not-prose my-10">
                            <div className="grid grid-cols-3 gap-2 sm:gap-3">
                              {['/images/cs-diverse-10.webp', '/images/cs-diverse-11.webp', '/images/cs-diverse-12.webp', '/images/cs-diverse-5.webp', '/images/cs-diverse-2.webp', '/images/cs-diverse-16.webp'].map((src, n) => (
                      ...
                      {i === sections.length - 1 && (
                        <div className="not-prose my-10">
                          ...
                          <div className="grid grid-cols-3 gap-2 sm:gap-3">
                            {['/images/cs-diverse-18.webp', '/images/cs-diverse-14.webp', '/images/cs-diverse-17.webp', '/images/cs-diverse-4.webp', '/images/cs-diverse-8.webp', '/images/cs-diverse-15.webp'].map((src, n) => (
                              <div key={n} className="relative aspect-square overflow-hidden rounded-lg">
