...
export const articles: SeedArticle[] = [
  ...
  },
  {
    ...
    body: '', // Loaded from seed-article-bodies.ts
    featureImage: 'https://images.unsplash.com/photo-1520986606214-8b456906c813?w=1200&h=800&fit=crop',
  ...
  },
  {
    ...
    featureImage: 'https://images.unsplash.com/photo-1526129318478-62ed807ebdf9?w=1200&h=800&fit=crop',
...
export const areas: SeedArea[] = [
  { name: 'South Kensington', slug: 'south-kensington', heroImage: 'https://images.unsplash.com/photo-1529655683826-aba9b3e77383?w=1200&h=600&fit=crop', description: 'Home to the V&A, Natural History Museum, and Science Museum, South Kensington is London\'s cultural powerhouse. Beautiful garden squares, French patisseries, and world-class institutions make it essential.' },
  ...
  { name: 'Shoreditch', slug: 'shoreditch', heroImage: 'https://images.unsplash.com/photo-1520986606214-8b456906c813?w=1200&h=600&fit=crop', description: 'East London\'s creative heartland. Street art, independent coffee shops, rooftop bars, and some of the city\'s best galleries.' },
  { name: 'Soho', slug: 'soho', heroImage: 'https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=1200&h=600&fit=crop', description: 'The beating heart of London\'s West End. World-class dining, legendary bars, independent cinemas, and nightlife in every direction.' },
  ...
  { name: 'Covent Garden', slug: 'covent-garden', heroImage: 'https://images.unsplash.com/photo-1505761671935-60b3a7427bad?w=1200&h=600&fit=crop', description: 'London\'s theatrical heart. Street performers, boutique shopping, world-class restaurants, and the Royal Opera House.' },
]
...
export const homepageArticles: SeedArticle[] = [
  ...
  },
  {
    ...
    body: '',
    featureImage: unsplash('1526129318478-62ed807ebdf9'),
  ...
  },
  {
    ...
    body: '',
    featureImage: unsplash('1520986606214-8b456906c813'),
  ...
  },
  {
    ...
    body: '',
    featureImage: unsplash('1529655683826-aba9b3e77383'),
...
export const homepageAreas: SeedArea[] = [
  { name: 'Shoreditch',   slug: 'shoreditch',    heroImage: unsplash('1520986606214-8b456906c813'), description: 'Street art, vintage shops, and some of London\'s best coffee.' },
  { name: 'Soho',         slug: 'soho',          heroImage: unsplash('1517248135467-4c7edcad34c4'), description: 'Theatreland, legendary bars, and the best restaurants in the West End.' },
  ...
  { name: 'Brixton',      slug: 'brixton',       heroImage: unsplash('1520986606214-8b456906c813'), description: 'Vibrant culture, incredible food, and a legendary music scene.' },
  { name: 'Greenwich',    slug: 'greenwich',     heroImage: unsplash('1529655683826-aba9b3e77383'), description: 'Maritime history, parkland views, and a brilliant weekend market.' },
  { name: 'Notting Hill',  slug: 'notting-hill',  heroImage: unsplash('1505761671935-60b3a7427bad'), description: 'Pastel houses, Portobello Road, and neighbourhood charm.' },
