...
export const articles: SeedArticle[] = [
  ...
  },
  {
    ...
    body: '', // Loaded from seed-article-bodies.ts
    featureImage: 'https://images.unsplash.com/photo-1534430480872-3498386e7856?w=1200&h=800&fit=crop',
...
export const areas: SeedArea[] = [
  { name: 'South Kensington', slug: 'south-kensington', heroImage: 'https://images.unsplash.com/photo-1501594907352-04cda38ebc29?w=1200&h=600&fit=crop', description: 'Home to the V&A, Natural History Museum, and Science Museum, South Kensington is London\'s cultural powerhouse. Beautiful garden squares, French patisseries, and world-class institutions make it essential.' },
...
export const homepageArticles: SeedArticle[] = [
  ...
  },
  {
    ...
    body: '',
    featureImage: unsplash('1534430480872-3498386e7856'),
  ...
  },
  {
    ...
    body: '',
    featureImage: unsplash('1542435503-956c469947f6'),
    category: hpCats.foodDrink,
  ...
  },
  {
    ...
    body: '',
    featureImage: unsplash('1501594907352-04cda38ebc29'),
