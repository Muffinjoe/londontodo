...
export const authors: SeedAuthor[] = [
  {
    name: 'Sophie Ellis',
    slug: 'sophie-ellis',
    image: '/images/authors/sophie-ellis.jpg',
...
export const articles: SeedArticle[] = [
  {
    ...
    featureImage: '/images/articles/london-weekend.jpg',
  ...
  },
  {
    ...
    body: '', // Loaded from seed-article-bodies.ts
    featureImage: '/images/articles/shoreditch-guide.jpg',
  ...
  },
  {
    ...
    featureImage: '/images/articles/free-exhibitions.jpg',
  ...
  },
  {
    ...
    body: '<p>Placeholder body content.</p>',
    featureImage: '/images/articles/new-restaurants-march.jpg',
  ...
  },
  {
    ...
    body: '<p>Placeholder body content.</p>',
    featureImage: '/images/articles/south-bank-walk.jpg',
  ...
  },
  {
    ...
    body: '<p>Placeholder body content.</p>',
    featureImage: '/images/articles/rooftop-bars.jpg',
...
export const areas: SeedArea[] = [
  { name: 'South Kensington', slug: 'south-kensington', heroImage: '/images/areas/south-kensington.jpg', description: 'Home to the V&A, Natural History Museum, and Science Museum, South Kensington is London\'s cultural powerhouse. Beautiful garden squares, French patisseries, and world-class institutions make it essential.' },
  { name: 'Southwark', slug: 'southwark', heroImage: '/images/areas/southwark.jpg', description: 'From the towering Shard to Borough Market\'s food stalls, Southwark blends old London charm with modern energy. The riverside walk from Tate Modern to Tower Bridge is unmissable.' },
  { name: 'South Bank', slug: 'south-bank', heroImage: '/images/areas/south-bank.jpg', description: 'The cultural corridor along the Thames. Home to the Southbank Centre, National Theatre, BFI, and some of the best street food in London.' },
  { name: 'Kew', slug: 'kew', heroImage: '/images/areas/kew.jpg', description: 'A leafy corner of southwest London, home to the world-famous Royal Botanic Gardens. Village charm, riverside walks, and botanical beauty.' },
  { name: 'Shoreditch', slug: 'shoreditch', heroImage: '/images/areas/shoreditch.jpg', description: 'East London\'s creative heartland. Street art, independent coffee shops, rooftop bars, and some of the city\'s best galleries.' },
  { name: 'Soho', slug: 'soho', heroImage: '/images/areas/soho.jpg', description: 'The beating heart of London\'s West End. World-class dining, legendary bars, independent cinemas, and nightlife in every direction.' },
  { name: 'Camden', slug: 'camden', heroImage: '/images/areas/camden.jpg', description: 'Loud, proud, and unapologetically alternative. Camden\'s famous market, live music venues, and canal-side pubs make it unmissable.' },
  { name: 'Covent Garden', slug: 'covent-garden', heroImage: '/images/areas/covent-garden.jpg', description: 'London\'s theatrical heart. Street performers, boutique shopping, world-class restaurants, and the Royal Opera House.' },
]
...
export const events: SeedEvent[] = [
  {
    ...
    featureImage: '/images/events/va-kimono.jpg',
  ...
  },
  {
    ...
    featureImage: '/images/events/borough-spring.jpg',
    category: { name: 'Food & Drink', slug: 'food-drink', color: '#f59e0b' },
  ...
  },
  {
    ...
    featureImage: '/images/events/jazz-weekend.jpg',
  ...
  },
  {
    ...
    featureImage: '/images/events/kew-orchids.jpg',
    category: { name: 'Exhibition', slug: 'exhibitions', color: '#6366f1' },
  ...
  },
  {
    ...
    featureImage: '/images/events/brick-lane-vintage.jpg',
...
export const promos: SeedPromo[] = [
  {
    ...
    image: '/images/promos/exhibitions-deal.jpg',
    sponsored: true,
  },
  {
